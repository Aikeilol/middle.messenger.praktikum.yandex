...
export class Input extends Block {
  ...
  componentDidMount(): void {
    ...
    content.setAttribute("placeholder",
      this.props.props?.placeholder
        ? String(this.props.props.placeholder)
        : '')
    content.setAttribute('autocomplete',
      this.props.props?.autocomplete
        ? String(this.props.props.autocomplete)
        : 'on')
